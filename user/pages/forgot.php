<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $res = mysqli_query($connection,"select * from login where username = '$username' and email = '$email' and status='1'");
        if(mysqli_num_rows($res)==1)
        {
          ...
          {
            $data = mysqli_query($connection, "update login set password = '$encpassword' where user_name = '$username'");
