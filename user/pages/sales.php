...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT b.*, c.name as customername, c.mobile as customermobile from bill as b
...
if (isset($_POST['Add'])) {
    ...
    $res = mysqli_query($connection, "INSERT INTO `bill`(`date`, `customerid`, `details`, `total`, `status`, `createdby`) 
                                        VALUES('$date','$customerid','$details','$total','1','$userid')
                                    ");
    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Sales Bill Added Successfully.";
...
if (isset($_POST['Edit'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `bill` SET 
    ...
    if (mysqli_affected_rows($connection) > 0) {
        $msg->value = 1;
        $msg->data = "Sales Bill Updated Successfully.";
        $msg->type = "alert alert-success alert-dismissible ";
    } else {
        $msg->value = 0;
        $msg->data = "Please Try Again";
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `bill` SET status = 0 WHERE id = '$id' ");

    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Sales Bill Deleted Successfully.";
        $msg->type = "alert alert-success alert-dismissible ";
    } else {
        $msg->value = 0;
...
<head>
    ...
    <title><?= $project ?> : Add Bill Details</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Sales Bill" data-toggle="modal" data-target="#modaladdsales"><i class="fa fa-plus"></i></a>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer ">
                            ...
                            <button type="submit" name="Edit" value="Edit" id='Edit' class="btn btn-success">Edit Bill</button>
                            <button type="button" class="btn pull-right btn-warning" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
    ...
    <script>
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            button2 = '<a ' +
                                ...
                                '" class="btn btn-xs btn-success view-button" style= "margin:5px" title=" View Sales bill"  href="salesitem.php?id=' + value.id + '" ><i class="fa fa-eye"></i></a>';
                            ...
                            button3 = '<button type="submit" name="Edit" id="Edit" ' +
                                ...
                                '" class="btn btn-xs btn-warning edit-button" style= "margin:5px" title=" Edit Sales bill" data-toggle="modal" data-target="#modaleditsales" ><i class="fa fa-edit"></i></button>';
            ...
            $(document).on("click", ".delete-button", function(e) {
                ...
                if (confirm('Are you sure to remove this bill?')) {
